...
> ⚠️ This file is ~600 lines and a Constellize `memory:revise` is overdue (flagged 2026-07-22 and still true). New entries go at the top; everything below the first `---` is history.
