...
**✅ Layout migrated (2026-08-31):** governance delta and ADRs moved from `docs/` to `llm/governance/` per agentic-governance ADR-0001 (control plane vs data plane); recorded here as ADR-0002. All moves via `git mv`, history intact. Dead `adr/`/`governance-delta.md` excludes removed from `docs/_config.yml`. Version pin v0.2 → v0.4. `construction/sprints/` deliberately out of scope.
