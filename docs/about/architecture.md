...
For the graph's node and edge types, see the [Reference → Domain Model & Taxonomy]({{ site.baseurl }}/reference/) section: the [Entity Catalog]({{ site.baseurl }}/reference/entity-catalog), [Entity Relationships]({{ site.baseurl }}/reference/entity-relationships), and [Topic Taxonomy]({{ site.baseurl }}/reference/topic-taxonomy).
