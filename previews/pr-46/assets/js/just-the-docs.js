...
function initSearch() {
  ...
  request.open('GET', '/agentic-kg/previews/pr-46/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/agentic-kg/previews/pr-46/assets/css/just-the-docs-' + theme + '.css');
}
