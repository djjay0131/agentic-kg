...
function initSearch() {
  ...
  request.open('GET', '/agentic-kg/previews/pr-35/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/agentic-kg/previews/pr-35/assets/css/just-the-docs-' + theme + '.css');
}
